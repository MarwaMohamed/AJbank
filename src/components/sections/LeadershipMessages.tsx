      ...
      <div className="relative z-10 flex-1">
        <div ref={panelsWrapRef} className="flex h-full">
          {cards.map((card, i) => (
            ...
            >
              <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-6 md:grid-cols-[1fr_minmax(250px,350px)] md:gap-10 lg:gap-16" style={{ paddingTop: "0.7vh", paddingBottom: "6vh", height: "100%" }}>
                {/* Text column (LEFT) */}
